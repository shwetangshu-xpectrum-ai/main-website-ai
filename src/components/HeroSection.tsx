        ...
        >
          <div className="relative w-full max-w-lg aspect-square">
            ...
            >
              ...
              <div className="text-white text-center px-8 text-3xl font-medium leading-tight z-10 font-lexend">
                Think the<br /><span className="text-yellow-200">Unthinkable</span><br />with us
              </div>
            </motion.div>
          </div>
        </motion.div>
